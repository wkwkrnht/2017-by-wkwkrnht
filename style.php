<style>
    @font-face{
        ...
        src:<?php echo 'url(' . get_template_directory_uri() . '/inc/font-awesome/fontawesome-webfont.eot)';?>;
        src:<?php echo 'url(' . get_template_directory_uri() . '/inc/font-awesome/fontawesome-webfont.eot?#iefix)';?> format('embedded-opentype'),
            <?php echo 'url(' . get_template_directory_uri() . '/inc/font-awesome/fontawesome-webfont.woff2)';?> format('woff2'),
            <?php echo 'url(' . get_template_directory_uri() . '/inc/font-awesome/fontawesome-webfont.woff)';?> format('woff'),
            <?php echo 'url(' . get_template_directory_uri() . '/inc/font-awesome/fontawesome-webfont.ttf)';?> format('truetype'),
            <?php echo 'url(' . get_template_directory_uri() . '/inc/font-awesome/fontawesome-webfont.svg#fontawesomeregular)';?> format('svg');
        font-weight:normal;
        font-style:normal;
    }
    .fa{
    ...
    :root{
        color:<?php echo get_option('root_color','#333');?>;
