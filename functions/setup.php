...
function wkwkrnht_setup(){
    ...
    */
    ...
    add_image_size('wkwkrnht-thumb-2560-full',2560,1440);
    add_image_size('wkwkrnht-thumb-1920-full',1920,1080);
    add_image_size('wkwkrnht-thumb-1600-full',1600,900);
    add_image_size('wkwkrnht-thumb-1366-full',1366,768);
    add_image_size('wkwkrnht-thumb-1280-full',1280,720);
    add_image_size('wkwkrnht-thumb-1024-full',1024,768);
    add_image_size('wkwkrnht-thumb-800-full',800,450);
    add_image_size('wkwkrnht-thumb-720-full',720,405);
    add_image_size('wkwkrnht-thumb-640-full',640,360);
    add_image_size('wkwkrnht-thumb-560-full',560,315);
    add_image_size('wkwkrnht-thumb-480-full',480,320);
    add_image_size('wkwkrnht-thumb-320-full',320,180);
    add_image_size('wkwkrnht-thumb-240-full',240,135);
    add_image_size('wkwkrnht-thumb-160-full',160,90);
